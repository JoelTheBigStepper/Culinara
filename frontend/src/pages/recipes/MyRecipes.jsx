...
export default function MyRecipes() {
  ...
  if (loading) return <div className="text-center mt-8 text-gray-500">Loading your recipes...</div>;
  if (error) return <div className="text-center mt-8 text-red-500">{error}</div>;
  if (recipes.length === 0) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-8 text-center text-lg text-gray-600">
        You haven't added any recipes yet.{" "}
        <Link to="/add" className="text-red-500 underline">Add one now!</Link>
      </div>
    );
  }
            ...
            <div className="p-4">
              ...
              <div className="grid grid-cols-2 gap-1 text-sm text-gray-500">
                <div className="flex items-center gap-1">
                  ...
                  <p className="font-medium hover:text-red-500">{recipe.cookTime || "N/A"}</p>
                </div>
                <div className="flex items-center gap-1">
